...
public class RoundedImageView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (drawable.getClass() == GlideBitmapDrawable.class) {
            GlideBitmapDrawable gb = (GlideBitmapDrawable) drawable;
            b = gb.getBitmap();
        } else if (drawable.getClass() == SquaringDrawable.class) {
            SquaringDrawable drawable1 = (SquaringDrawable) drawable;
            b = drawableToBitmap(drawable1);
        } else
